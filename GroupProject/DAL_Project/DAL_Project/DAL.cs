...
namespace DAL_Project
{
    ...
    /// Example usage:
    /// 
    /// // A) No procedures, just a select with a resulting DataSet (used on a GridView)
    ...
    public class DAL
    {
        ...
        {
            _parameters.Add(new SqlParameter(paramName, paramValue, System.Data.SqlDbType.Char,)); // create a new SqlParameter object with the use chosen values, add it to the internal list of parameters         
        }
